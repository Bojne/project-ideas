  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Yueh Han.
          </BigTitle>
          <Subtitle><ContactText>I generate ideas everyday. This is the place I back-up that part of my brain.<br></br> Feel free to <a href="mailto:yhhuang@minerva.kgi.edu">contact</a> me for further discussion!</ContactText></Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Stay In My Dorm"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Connecting Minerva, Stanford and Berkley students throught overnight stay in dorms.
            </ProjectCard>
            <ProjectCard
              title="Global Common Room"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              Connecting Minerva Residential Hall Common room through video stream.
            </ProjectCard>
            <ProjectCard
              title="Scan LCD"
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            ...
            <a href="https://fb.me/bojne.john">Facebook</a> &{' '}
            <a href="https://www.instagram.com/johann019/">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
